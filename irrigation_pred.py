...
#-----------Titre du Projet ---------------
st.title("IRRIGATION :red[SMART]")

st.markdown("#### Projet fil conducteur")
st.markdown("Auteur : **Osée AKOUEHOU | Data Scientist / IA**")
...
# --- Stocker les données renseignées dans une DataFrame ---
X_new = pd.DataFrame([{
    'Soil_Type': Soil_Type,
